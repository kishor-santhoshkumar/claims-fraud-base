...
import { getRuleFireRates } from '../api'

// Fetches real batch-level rule fire rates for the given provider_ids.
// `enabled: false` skips the fetch (status stays 'idle').
export function useRuleFireRates(providerIds, { enabled = true } = {}) {
